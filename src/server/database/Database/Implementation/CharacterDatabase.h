...
enum CharacterDatabaseStatements : uint32
{
    ...
    */
    ...
    //Coupon System
    CHAR_INS_COUPON_CODE,
    CHAR_SEL_COUPON_CODE,
    CHAR_INS_COUPON_CODE_ACCOUNT,
    CHAR_SEL_COUPON_CODE_ACCOUNTS,
    CHAR_SEL_COUPONT_CODE_ACCOUNTS,
    CHAR_UPD_COUPON_CODE,
    CHAR_SEL_COUPON_REWARD,
    CHAR_SEL_COUPON_REWARDS,
