...
void CharacterDatabaseConnection::DoPrepareStatements()
{
	...
	PrepareStatement(CHAR_INS_PLAYER_REPORT_QUEST, "Insert into reported_quest_player (playername,guid, reported_quest_id) Values (?,?,?)", CONNECTION_SYNCH);
	PrepareStatement(CHAR_SEL_PLAYER_REPORT_QUEST, "SELECT guid from reported_quest_player where guid = ? and reported_quest_id = ?", CONNECTION_SYNCH);
	/* CUSTOM ENDE */
