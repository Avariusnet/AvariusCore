...
public:
	...
	bool OnGossipHello(Player* player, Creature* creature)
	{
		...
		if (sConfigMgr->GetBoolDefault("Race.Change", true)) {
			...
			player->PlayerTalkClass->GetGossipMenu().AddMenuItem(-1, GOSSIP_ICON_CHAT, "Racechange Cost: 500 Gold & 2 Frostmarken", GOSSIP_SENDER_MAIN, 1, "", 0, false);
			player->PlayerTalkClass->GetGossipMenu().AddMenuItem(-1, GOSSIP_ICON_CHAT, "Factionchange Cost: 500 Gold & 2 Frostmarken", GOSSIP_SENDER_MAIN, 2, "", 0, false);
			player->PlayerTalkClass->GetGossipMenu().AddMenuItem(-1, GOSSIP_ICON_CHAT, "Race & Factionchange Cost: 1000 Gold & 4 Frostmarken.", GOSSIP_SENDER_MAIN, 3, "", 0, false);
			player->PlayerTalkClass->GetGossipMenu().AddMenuItem(-1, GOSSIP_ICON_CHAT, "Rename Kosten: Cost Gold", GOSSIP_SENDER_MAIN, 4, "", 0, false);
